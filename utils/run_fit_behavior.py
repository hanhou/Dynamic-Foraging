...
if __name__ == '__main__':
    ...
    model_comparison = behavior_model_comparison(data, pool = pool, models = [1,9,10,11,12,13,14,15], use_trials = None) #np.r_[0:100])
